...
document.write ('<div id="second_wrapper1" style="position:relative; left:'+AdMarginLeft+'px; top:0px; text-align:left; margin:0 auto;">\n');
document.write ('<div id="FloatLayer1" STYLE="position:absolute; width:'+AdWidth+'px; height:'+AdHeight+'px; z-index:300; top:'+AdMarginTop+'px; display:block;">\n');
